...
public class InstanceDeckService : IInitializable
{
    /// <summary>
    ...
    */
    ...
    {
        Trace.Log("THIS IS ENTITYDECKSERVICE!");
    ...
    /*
    public List<InstanceCard> GetInitialDeck(string initString)
    {
    ...
    private async void BuildInstanceDeck()
    {
        //Deserialize instance json file.
